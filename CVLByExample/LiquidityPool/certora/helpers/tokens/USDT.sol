...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) virtual override(ERC20Basic) {
    ...
    */
    function balanceOf(address _owner) public view override(ERC20Basic) virtual returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function transferFrom(address _from, address _to, uint _value) public onlyPayloadSize(3 * 32) override(ERC20) virtual {
    ...
    */
    function approve(address _spender, uint _value) public onlyPayloadSize(2 * 32) override(ERC20) virtual {
    ...
    */
    function allowance(address _owner, address _spender) public view override(ERC20) virtual returns (uint remaining) {
...
contract USDT is Pausable, StandardToken, BlackList {
    ...
    bool public constant deprecated = false; 
